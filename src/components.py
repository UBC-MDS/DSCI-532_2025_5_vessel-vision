...
def create_map(filtered_df):
    ...
    # Ensure DataFrame is not empty before calculating bounds
    ...
    # Calculate bounding box (min/max lat/lon)
    ...
    fig.update_layout(
        mapbox_bounds={"west": min_lon, "east": max_lon, "south": min_lat, "north": max_lat},
